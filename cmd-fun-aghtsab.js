// خنق.js - أمر خنق متكامل
const fs = require('fs');
const path = require('path');
const { downloadContentFromMessage } = require('@whiskeysockets/baileys');

const globalStickerPath = path.join(__dirname, 'db-global_choke_sticker.json');
...
module.exports = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      if (subCommand === 'حفظ' || subCommand === 'save') {
        ...
        if (!quoted || !quoted.stickerMessage) {
          await sock.sendMessage(chatId, {
            text: `📌 حفظ ملصق اغتصاب\n━━━━━━━━━━━━━━━━━━━━\n❌ يجب الرد على ملصق (ستيكر)\n📝 .-اغتصاب حفظ (رد على ملصق)\n━━━━━━━━━━━━━━━━━━━━\n𝘽𝙔┇𝑷𝑯𝑨𝑵𝑻𝑶𝑴 ❤️`
          }, { quoted: msg });
          await sock.sendMessage(chatId, { react: { text: '❌', key: msg.key } });
          return;
        }
        ...
        await sock.sendMessage(chatId, {
          text: `✅ تم حفظ ملصق تحرش عاماً!\n━━━━━━━━━━━━━━━━━━━━\n📌 استخدم .اغتصاب @منشن للإرسال\n👤 بواسطة: ${displayName}\n━━━━━━━━━━━━━━━━━━━━\n𝘽𝙔┇𝑷𝑯𝑨𝑵𝑻𝑶𝑴 ❤️`,
      ...
      if (who === chatId) {
        await sock.sendMessage(chatId, {
          text: `❌ لا يمكنك اغتصاب المجموعة فاكر نفسك حمدي الوزير 😂🫵!`
        }, { quoted: msg });
        await sock.sendMessage(chatId, { react: { text: '❌', key: msg.key } });
        return;
      }
      ...
      if (!savedSticker) {
        await sock.sendMessage(chatId, {
          text: `❌ لا يوجد ملصق اغتصاب محفوظ.\n📌 قم بحفظ ملصق أولاً: .اغتصاب حفظ (رد على ملصق)`
        }, { quoted: msg });
        await sock.sendMessage(chatId, { react: { text: '❌', key: msg.key } });
        return;
      }
      ...
      await sock.sendMessage(
        chatId,
        {
          text: `@${senderName} يغتصب 😱 @${targetName} 😵`,
          mentions: [sender, who]
        },
        { quoted: msg }
      );
      ...
      console.error('✗ خطأ في أمر تحرش:', error);
      await sock.sendMessage(
        msg.key.remoteJid,
        {
