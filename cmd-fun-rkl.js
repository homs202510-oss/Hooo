// ركل.js - أمر ركل متكامل (حفظ عام + إرسال مع أسماء حقيقية)
const fs = require('fs');
const path = require('path');
const { downloadContentFromMessage } = require('@whiskeysockets/baileys');

const globalStickerPath = path.join(__dirname, 'db-global_kick_sticker.json');
...
module.exports = {
  name: 'ركل',
  command: ['ركل'],
  description: '👟 ركل شخص (حفظ عام + إرسال مع أسماء حقيقية)',
  category: 'تسلية',
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      if (subCommand === 'حفظ' || subCommand === 'save') {
        ...
        await sock.sendMessage(chatId, {
          text: `✅ تم حفظ ملصق الركل عاماً!\n━━━━━━━━━━━━━━━━━━━━\n📌 استخدم .ركل @منشن للإرسال\n👤 بواسطة: ${displayName}\n━━━━━━━━━━━━━━━━━━━━\n𝘽𝙔┇𝑷𝑯𝑨𝑵𝑻𝑶𝑴 ❤️`,
      ...
      // منع ركل النفس أو المجموعة
      if (who === sender) {
        await sock.sendMessage(chatId, {
          text: `❌ لا يمكنك ركل نفسك!`
        }, { quoted: msg });
        await sock.sendMessage(chatId, { react: { text: '❌', key: msg.key } });
        return;
      }
      ...
      if (!savedSticker) {
        await sock.sendMessage(chatId, {
          text: `❌ لا يوجد ملصق ركل محفوظ.\n📌 قم بحفظ ملصق أولاً: .ركل حفظ (رد على ملصق)`
        }, { quoted: msg });
        await sock.sendMessage(chatId, { react: { text: '❌', key: msg.key } });
        return;
      }
      ...
      await sock.sendMessage(
        chatId,
        {
          text: `@${senderName} يركل @${targetName} 👟`,
          mentions: [sender, who]
        },
        { quoted: msg }
      );
      ...
      console.error('✗ خطأ في أمر ركل:', error);
      await sock.sendMessage(
        msg.key.remoteJid,
        {
