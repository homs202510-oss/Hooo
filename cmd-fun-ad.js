// عض.js - أمر عض متكامل (حفظ عام + إرسال مع أسماء حقيقية)
const fs = require('fs');
const path = require('path');
const { downloadContentFromMessage } = require('@whiskeysockets/baileys');

const globalStickerPath = path.join(__dirname, 'db-global_bite_sticker.json');
...
module.exports = {
  name: 'عض',
  command: ['عض'],
  description: '🦷 عض شخص (حفظ عام + إرسال مع أسماء حقيقية)',
  category: 'تسلية',
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      if (subCommand === 'حفظ' || subCommand === 'save') {
        ...
        await sock.sendMessage(chatId, {
          text: `✅ تم حفظ ملصق العض عاماً!\n━━━━━━━━━━━━━━━━━━━━\n📌 استخدم .عض @منشن للإرسال\n👤 بواسطة: ${displayName}\n━━━━━━━━━━━━━━━━━━━━\n𝘽𝙔┇𝑷𝑯𝑨𝑵𝑻𝑶𝑴 ❤️`,
      ...
      // منع عض النفس أو المجموعة
      if (who === sender) {
        await sock.sendMessage(chatId, {
          text: `❌ لا يمكنك عض نفسك!`
        }, { quoted: msg });
        await sock.sendMessage(chatId, { react: { text: '❌', key: msg.key } });
        return;
      }
      ...
      if (!savedSticker) {
        await sock.sendMessage(chatId, {
          text: `❌ لا يوجد ملصق عض محفوظ.\n📌 قم بحفظ ملصق أولاً: .عض حفظ (رد على ملصق)`
        }, { quoted: msg });
        await sock.sendMessage(chatId, { react: { text: '❌', key: msg.key } });
        return;
      }
      ...
      await sock.sendMessage(
        chatId,
        {
          text: `@${senderName} يعض @${targetName} 🦷`,
          mentions: [sender, who]
        },
        { quoted: msg }
      );
      ...
      console.error('✗ خطأ في أمر عض:', error);
      await sock.sendMessage(
        msg.key.remoteJid,
        {
